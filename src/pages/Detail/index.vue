        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前路由跳转，从a跳转到b，这里在加入购物车，进行路由跳转之前，发请求，把你购买产品信息通过请求的形式通知服务器，服务器进行相应存储 -->
...
export default {
  ...
  methods: {
   ...
   async addShopcar(){
      ...
      // 2.判断加入购物车是否成功，进行相应的操作，调用仓库中的函数，这个方法加上asyc，返回的一定是Promise 要不成功|失败
     try {
      ...
      //一些复杂的数据【比较复杂：skuInfo】，通过会画存储（不持久化，会画结束数据消失）
      //不管是本地存储|会画存储，一般存储的是字符串
